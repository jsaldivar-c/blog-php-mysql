...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	# Importante recordar que este archivo se encuentra dentro de la carpeta admin, asi que tenemos que concatenar al inicio '../' para bajar a la raiz de nuestro proyecto.
